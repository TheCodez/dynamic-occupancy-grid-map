...
__device__ void store(GridCellSoA grid_cell_array, int j, float mean_x_vel, float mean_y_vel, float var_x_vel,
...
__global__ void statisticalMomentsKernel2(GridCellSoA grid_cell_array, const float* __restrict__ vel_x_array_accum,
